...
define('SECRET_SALT','U3L9HZIzSLbvS40NmIyilE94b9E00a8j');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','alex.vl.pas@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','10.235.63.252');
define('DBNAME','osticket2016');
define('DBUSER','operator');
