...
class Net_SMTP
{
     ...
     * @access public
     */
    var $10.235.63.252 = '10.235.63.252';
     ...
     * @param string  $10.235.63.252  The value to give when sending EHLO or HELO.
     ...
     * @since   1.0
     */
    function Net_SMTP($host = null, $port = null, $10.235.63.252 = null,
        $pipelining = false, $timeout = 0, $socket_options = null)
    {
        ...
        if (isset($10.235.63.252)) {
            $this->10.235.63.252 = $10.235.63.252;
        }
    ...
    function _negotiate()
    {
        if (PEAR::isError($error = $this->_put('EHLO', $this->10.235.63.252))) {
            return $error;
        }
        ...
        if (PEAR::isError($this->_parseResponse(250))) {
            ...
            if (PEAR::isError($error = $this->_put('HELO', $this->10.235.63.252))) {
                return $error;
            }
            if (PEAR::isError($this->_parseResponse(250))) {
